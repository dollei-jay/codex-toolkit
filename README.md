...
<p align="center">
  <strong>面向 Codex 用户的本地优先桌面增强工具：token 监控、中转站管理、历史同步与一键重启。</strong>
</p>
...
<p align="center">
  <img src="./docs/images/local-router-config.png" alt="Codex Toolkit 本地路由器配置面板" width="420" />
</p>
...
<p>
  <img src="./docs/images/local-router-config.png" alt="Codex Toolkit 本地路由器配置面板" width="31%" />
  <img src="./docs/images/relay-token-trends.png" alt="Codex Toolkit 中转站 token 用量趋势" width="31%" />
  <img src="./docs/images/history-sync.png" alt="Codex Toolkit 历史同步 Provider 记录面板" width="31%" />
</p>

<p>
  <img src="./docs/images/relay-management.png" alt="Codex Toolkit 中转站配置面板" width="31%" />
  <img src="./docs/images/app-screenshot.png" alt="Codex Toolkit 深色仪表盘" width="31%" />
  <img src="./docs/images/about-panel.png" alt="Codex Toolkit 关于信息面板" width="31%" />
</p>
...
- `~/.codex/sessions` 和 `~/.codex/archived_sessions` 下的 rollout 会话文件
- `~/.codex/state_5.sqlite` 中的线程记录
- 工具创建的历史同步备份数量
...
1. 解析 Codex 会话日志目录
2. 递归扫描 `.jsonl` 文件
3. 从首行 `session_meta` 读取 `model_provider`
4. 提取 `token_count` 事件
